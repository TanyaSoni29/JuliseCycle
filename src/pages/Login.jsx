				...
				<section className='relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6'>
					...
					<div className='hidden lg:relative lg:block lg:p-12'>
						...
						<h2 className='flex flex-row gap-2 justify-start items-center mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl'>
							Welcome to Rolling Wheels <IoIosBicycle />
						</h2>

						<p className='mt-4 leading-relaxed text-white/90'>
							Rolling Cycle Limited is a company registered in Kanpur & Wales
							with company number 01234567. Registered office: 212-216 Kanpur
							Park Road, INDIA, LE3 3AK. VAT number: 224 4599 89.
						</p>
					</div>
				</section>
					...
					<div className='max-w-xl lg:max-w-3xl'>
						<div className='relative -mt-16 block lg:hidden'>
							<Link
								...
								to='/'
							>
								<p className='text-3xl font-bold italic text-white text-center'>
									JC
								</p>
							</Link>
							...
							<p className='mt-4 leading-relaxed text-gray-500'>
								Julie's Cycles Limited is a company registered in England &
								Wales with company number 05616464. Registered office: 212-216
								Clarendon Park Road, LEICESTER, LE2 3AG. VAT number: 114 3499
								79.
							</p>
						</div>
						...
						>
							...
							<div className='col-span-6'>
								<Link
									to='/forgetPassword'
									className='flex justify-end items-center text-sm text-gray-700'
								>
									Forget Password?
								</Link>
							</div>
