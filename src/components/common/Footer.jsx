...
function Footer() {
  return (
    <div className='mt-20 w-full'>
             <div className="mx-auto w-9/12 px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-teal-600 sm:justify-start">
          <img src={logoImg} alt='logoImg' width={300} height={300} />
        </div>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-slate-100">Information</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-slate-100">Customer Services</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-slate-100">Opening Times</p>
